<template>
  <div style="background-color: rgba(239,250,246,0.53)">
    ...
    <div style="width: 80%;margin-left: 1%" class="main">
      <el-card shadow="hover" v-for="(message,index) in Massages" :key="index">
        ...
        <div style="height:100px">
          ...
          <div style="display:inline-block;margin-left: 5%">
            <p class="message">{{message.info}} 通过了你的好友请求 &nbsp;&nbsp;<i class="el-icon-lollipop"></i></p>
            <br>
          </div>
