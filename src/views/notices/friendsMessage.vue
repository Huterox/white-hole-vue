      ...
      <el-card shadow="hover" v-for="(message,index) in Messages" :key="index">
        ...
        <div style="height:100px">
          ...
          <div style="display:inline-block;margin-left: 5%">
            <p class="message">{{message.from}} 有消息最新消息 &nbsp;&nbsp;<i class="el-icon-chat-dot-round"></i></p>
...
export default {
  ...
  data(){
    return{
      total: 999,
      Messages:[
        {"from":"Futerox","data":"2022-3-27","link":"点击查看"},
        {"from":"Huterox","data":"2022-3-27","link":"点击查看"},
        {"from":"小刚","data":"2022-3-27","link":"点击查看"},
        {"from":"Future","data":"2022-3-27","link":"点击查看"},
      ]
    }
  },
}
